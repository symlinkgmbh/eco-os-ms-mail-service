...
import { Heartbeat, MailRoute, MetricsRoute, LicenseBeat, ConfigBeat } from "./routes";
...
export class Router implements PkApi.IRouter {
  ...
  protected mailRoute: MailRoute | undefined;
  ...
  public initRoutes(): void {
    ...
    this.mailRoute = new MailRoute(this.app);
